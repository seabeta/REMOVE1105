...
feature_ranges = {
    ...
    "MBI": {"type": "numerical", "min": 0, "max": 100, "default": 40},
    "FOIS": {"type": "numerical", "min": 1, "max": 6, "default": 3},
    "Lip movement ability": {"type": "categorical", "options": [0, 1], "default": 0},
    "Cerebellar_injury":{"type": "categorical", "options": [0, 1], "default": 0},
    "Tracheotomy": {"type": "categorical", "options": [0, 1], "default": 0},
    "Tongue mobility":{"type": "categorical", "options": [0, 1], "default": 0},
